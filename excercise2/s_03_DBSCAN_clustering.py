...
def estimate_eps_with_kdist(matrix, min_samples=5, quantile=0.80):
    ...
    Steps:
      ...
      4. Take a high quantile (e.g. 90%) of these k-dist values as eps.
    ...
    print(f"  → Estimated eps = {eps:.4f} (from {quantile*100:.0f}th percentile of {min_samples}-nearest neighbor distances)")
...
def main():
    ...
    # - Take the 90th percentile as eps (captures most dense regions, ignores extreme outliers)
    ...
    # Simple summary: cluster counts (including noise = -1)
    ...
    params = {
        ...
        "heuristic": {
            ...
            "quantile": 0.90,
            "description": (
                "eps chosen as 90th percentile of k-distances (k = min_samples) "
